...
$(function() {
    ...
    var squares = [],
      ...
      set = function() {
        ...
        if (win(score[turn])) {
          alert(turn + " wins! Great Job! Play Again?");
          startNewGame();
       ...
       */
      play = function() {
        var board = $("<table border=1 bordercolor=white cellspacing=0>"),
          indicator = 1;
        for (var i = 0; i < SIZE; i += 1) {
          var row = $("<tr>");
          board.append(row);
          for (var j = 0; j < SIZE; j += 1) {
            var cell = $("<td height=80 width=80 align=center valign=center></td>");
